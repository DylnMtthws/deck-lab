(function () {
  ...
  function syncResultDestinations() { var label = destinationName(addDestinationId()); document.querySelectorAll("[data-card-results] [data-add-result]").forEach(function (button) { button.setAttribute("aria-label", "Add " + button.dataset.addResult + " to " + label); }); }
  ...
  function chooseOption(option) {
    ...
    addCard(option.dataset.cardId, zoneId);
    var input = document.querySelector("[data-card-search]");
    if (input) { input.value = ""; input.focus(); }
    closeCardResults();
    searchStatus("Added " + (option.dataset.cardName || "card") + " to " + label + ".");
  }
